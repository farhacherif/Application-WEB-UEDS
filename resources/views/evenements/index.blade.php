...
<head>
    <meta charset="UTF-8">
        <title>Evenements | Josh Admin Template</title>
                ...
                <div class="panel panel-primary ">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <i class="livicon" data-name="activite" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i> Liste des evenements
                        </h4>
                    </div>
                    <br />
                        ...
                        <table class="table table-bordered " id="table">
                            ...
                            @foreach($evenements as $evenement)
                                ...
                                <tr>
                                    ...
                                    <td>{!! strip_tags($evenement->description) !!}</td>
                                    <td>{{$evenement->date}}</td>
                                    <td>{{$evenement->lieu}}</td>
                                           <td name="image" id="image"> <img src="{{url('/images/'.$evenement->image)}}" alt="" style="width:150px; height:150px"></td>
                                    <td>
                                     <a href="{{ url('/evenements/edit',$evenement)}}" class="btn btn-primary" >Modifier</a>

                                    <a title="Supprimer" href="{{url('/evenements/delete/'.$evenement->id)}}" onclick="return confirm('etes vous sur de vouloir supprimer cet évènement ?')" class="btn btn-danger">supprimer</a>
                                    </td>
