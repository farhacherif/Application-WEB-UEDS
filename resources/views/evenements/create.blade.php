...
<head>
    <meta charset="UTF-8">
    <title>Ajouter évènement | Josh Admin Template</title>
...
<div class="wrapper row-offcanvas row-offcanvas-left">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="livicon" data-name="calendar" data-size="18" data-c="#fff" data-hc="#fff" data-loop="true"></i> Ajouter un évènement
                            </h3>
  ...
  <form method ="Post" action ="{{ url('/evenements/store') }}"  enctype="multipart/form-data">
      {{csrf_field() }}
    <div class="form-group">
      <label for="exampleInputLibelle">Nom de l'évènement:</label>
      <input type="text" class="form-control" name="libelle" id="libelle" placeholder="Nom">
    </div>
