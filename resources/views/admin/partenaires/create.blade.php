    ...
    <aside class="right-side">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Ajouter un partenaire </li>
            </ol>
        </section>
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="livicon" data-name="user-add" data-size="18" data-c="#fff" data-hc="#fff" data-loop="true"></i> Ajouter partenaire
                            </h3>
                        ...
                        <div class="panel-body">
                            <!-- errors -->
                            <!--main content-->   <form role="form" method="post"  action="{{ url('/partenaires/store') }}" enctype="multipart/form-data">
                                {{csrf_field()}}
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="box-body">
                                                ...
                                                <div class="box-body">
                                                        <div class="form-group"  >
                                                            ...
                                                            <input type="tel" name="tel" class="form-control"  placeholder="Entrer le numéro de téléphone...">
                                    ...
                                    <div class="form-group" >
                                            ...
                                            <input type="number" name="code" class="form-control"  placeholder="Entrer code...">
    
                                        </div>
            
                                        <div class="box-body">
                                                <label for="exampleInputDescription">Présentation de l'entreprise :</label>
                                                <div class="form-group">
                                          
                                                            <textarea class="description" name="description" id="tinymce_full" class="form-controller" cols="170" rows="5"></textarea>
                                              </div>
                                    <div class="box-body">
                                    <div class="form-group">
