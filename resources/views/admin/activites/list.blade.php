...
<head>
    <meta charset="UTF-8">
        <title>Activites | Josh Admin Template</title>
    ...
    <aside class="right-side">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Liste des activites</li>
            </ol>
        </section>
        <!-- Main content -->
                ...
                <div class="panel panel-primary ">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <i class="livicon" data-name="activite" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i> Liste des activites
                        </h4>
                    </div>
                    <br />
                        ...
                        <table class="table table-bordered " id="table">
                            ...
                            @foreach($activites as $activite)
                                ...
                                <tr>
                                    ...
                                    <a title="Supprimer" href="{{url('/activites/delete/'.$activite->id)}}" onclick="return confirm('etes vous sur de vouloir supprimer cette activite ?')" class="btn btn-danger">supprimer</a>
                                    </td>
