...
<head>
    <meta charset="UTF-8">
    <title>Demande de participation | Josh Admin Template</title>
    ...
    <aside class="right-side">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="#">Demande de participation</a>
                </li>
                <li class="active">Liste des Demande de participation</li>
            </ol>
        </section>
        <!-- Main content -->
                ...
                <div class="panel panel-success ">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <i class="livicon" data-name="partenaire" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i> Liste des Demande de participation
                        </h4>
                    </div>
                    <br />
                          ...
                          @foreach ($evenements as $evenement )
                                ...
                                <tr>
                                    ...
                                    <td>
                                       ...
                                       <a href="{{url('/participation/activer',$event_user->id)}}" class="btn btn-success">
                                                        <i class="livicon" data-name="user-add" data-loop="true" data-color="#000" data-hovercolor="black" data-size="14"></i>
                                                        Accepter
                                                    </a>
                                                    <hr>
                                                    <a href="{{url('admin/participation/destroy',$event_user->id)}}" class="btn btn-danger">
