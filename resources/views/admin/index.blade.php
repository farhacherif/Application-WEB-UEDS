                            ...
                            <div class="col-xs-12 pull-left nopadmar">
                                <div class="row">
                                    <div class="square_box col-xs-7 text-right">
                                        <span>Nombre des donateurs</span>
                                        <div class="number" >{{$users}}</div>
                                    </div>


                                    <i class=" livicon col-lg-2 col-md-3 col-sm-3 col-xs-6 text-center l1" data-name="briefcase" data-l="true" data-c="#fff" data-hc="#fff" data-s="70"></i>
                                </div>
                                <div class="row">
                        ...
                        <div class="panel-heading">
                            ...
                            <div class="btn-group pull-right">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    ...
                                    <li>
                                        <a class="panel-config" href="{{asset('josh/HTML Version/#panel-config')}}" data-toggle="modal">
