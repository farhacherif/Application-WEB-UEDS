    ...
    <aside class="right-side">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Modifier presse </li>
            </ol>
        </section>
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="livicon" data-name="user-add" data-size="18" data-c="#fff" data-hc="#fff" data-loop="true"></i> Modifier presse
                            </h3>
                        ...
                        <div class="panel-body">
                            <!-- errors -->
                            <!--main content--> 
                              <form role="form" method="post"  action="{{url('admin/presses/update/'.$presse->id)}}" enctype="multipart/form-data">
                                {{csrf_field()}}

                                <div class="box-body">
                                    <div class="form-group" >
                                        <label for="exampleInputEmail1">Nom</label>
                                        <input type="text" name="nom" class="form-control"  placeholder="Enter le nom" value="{{ $presse->nom}}">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputFile">Image</label>
                                        <div class="caption">  
                                        <img src="{{url('/images/'.$presse->image)}}" alt="" style="width:150px; height:150px">
