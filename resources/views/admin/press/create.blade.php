...
<head>
    <meta charset="UTF-8">
    <title>Ajouter presse | Josh Admin Template</title>
    ...
    <aside class="right-side">
            <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Ajouter presse </li>
                    </ol>
                </section>
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="livicon" data-name="brush" data-size="18" data-c="#fff" data-hc="#fff" data-loop="true"></i> Ajouter presse
                            </h3>
                        ...
                        <div class="panel-body">
                            <!-- errors -->
                            <!--main content-->   <form role="form" method="post"  action="{{ url('admin/presses/store') }}" enctype="multipart/form-data">
                                {{csrf_field()}}
