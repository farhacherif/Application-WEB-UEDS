<head>
    ...
    <link rel="stylesheet" media="all" href="{{asset('josh/HTML Version/vendors/bower-jvectormap/css/jquery-jvectormap-1.2.2.css')}}" />
    <link rel="stylesheet" href="{{asset('josh/HTML Version/vendors/animate/animate.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('josh/HTML Version/vendors/datetimepicker/css/bootstrap-datetimepicker.min.css')}}">
    <link rel="stylesheet" href="{{asset('josh/HTML Version/css/pages/only_dashboard.css')}}" />
    <link href="{{asset('josh/HTML Version/vendors/fullcalendar/css/fullcalendar.css')}}" rel="stylesheet" type="text/css" />
