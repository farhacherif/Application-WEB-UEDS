...
<head>
    <meta charset="UTF-8">
    <title>Ajouter bénévole | Josh Admin Template</title>
    ...
    <aside class="right-side">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Ajouter un bénévole </li>
            </ol>
        </section>
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="livicon" data-name="user-add" data-size="18" data-c="#fff" data-hc="#fff" data-loop="true"></i> Ajouter bénévole
                            </h3>
                        ...
                        <div class="panel-body">
                            <!-- errors -->
                            <!--main content-->   <form role="form" method="post"  action="{{ url('/users/store') }}" enctype="multipart/form-data">
                                {{csrf_field()}}

                                <div class="box-body">
                                    <div class="form-group" >
                                        <label for="exampleInputEmail1">Nom</label>
                                        <input type="text" name="name" class="form-control"  placeholder="Enter le nom">
