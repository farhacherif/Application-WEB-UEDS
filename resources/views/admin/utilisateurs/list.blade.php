    ...
    <aside class="right-side">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Liste des bénévoles</li>
            </ol>
        </section>
        <!-- Main content -->
                ...
                <div class="panel panel-primary ">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <i class="livicon" data-name="user" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i> Liste des bénévoles
                        </h4>
                    </div>
                    <br />
                                 ...
                                 <td>{{$user->presentation}}</td>
                                    ...
                                    <a href="{{route('profile',['id'=>$user->id])}}">                                            <i class="livicon" data-name="info" data-size="18" data-loop="true" data-c="#428BCA" data-hc="#428BCA" title="view user"></i>
                                       ...
                                       <!-- <a href="{{url('user/destroy',$user->id)}}" data-toggle="modal" data-target="#delete_confirm">
                                        ...
                                        {{ csrf_field() }}
                                        <a href="{{url('/admin/desactiver',$user->id)}}" class="btn btn-danger" onclick="return confirm('Voulez vous vraiment desactiver cet utilisateur ?')"class="btn btn-default" >Desactiver</a>
                                    </form>
