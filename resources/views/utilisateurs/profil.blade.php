...
<head>
  <meta charset="utf-8" />
  <link rel="apple-touch-icon" sizes="76x76" href="{{asset('member/assets/img/apple-icon.png')}}">
  <link rel="icon" type="image/png" href="{{asset('member/assets/img/favicon.png')}}">
      ...
      <div class="logo">
        <a href="http://www.creative-tim.com" class="simple-text logo-mini">
          <div class="logo-image-small">
            <img src="{{asset('member/assets/img/logo-small.png')}}">
          </div>
        </a>
        <a href="http://www.creative-tim.com" class="simple-text logo-normal">
          Creative Tim
          <!-- <div class="logo-image-big">
            <img src="{{asset('member/assets/img/logo-big.png')}}">
          </div> -->
        </a>
      </div>
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="card card-user">
              <div class="image">
                <img src="{{asset('member/assets/img/damir-bosnjak.jpg')}}" alt="...">
              </div>
              <div class="card-body">
                <div class="author">
                  <a href="#">
                    <img class="avatar border-gray" src="{{asset('member/assets/img/mike.jpg')}}" alt="...">
                ...
                <ul class="list-unstyled team-members">
                  <li>
                    <div class="row">
                      <div class="col-md-2 col-2">
                        <div class="avatar">
                          <img src="{{asset('member/assets/img/faces/ayo-ogunseinde-2.jpg')}}" alt="Circle Image" class="img-circle img-no-padding img-responsive">
                        </div>
                      </div>
                  ...
                  <li>
                    <div class="row">
                      <div class="col-md-2 col-2">
                        <div class="avatar">
                          <img src="{{asset('member/assets/img/faces/joe-gardner-2.jpg')}}" alt="Circle Image" class="img-circle img-no-padding img-responsive">
                        </div>
                      </div>
                      <div class="col-md-7 col-7">
                        Creative Tim
                  ...
                  <li>
                    <div class="row">
                      <div class="col-md-2 col-2">
                        <div class="avatar">
                          <img src="{{asset('member/assets/img/faces/clem-onojeghuo-2.jpg')}}" alt="Circle Image" class="img-circle img-no-padding img-responsive">
                        </div>
                      </div>
